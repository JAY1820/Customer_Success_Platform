...
const VersionHistory = ({ project, setFetch, updateProjectData }) => {
  ...
  return (
    <>
      {/* Modal for Adding Version History */}
      <button
        onClick={openModal}
      ...
      <Modal
        ...
        style={customStyles}
        contentLabel="Version History Modal"
      >
        <form
      ...
      {/* Table for displaying Version History */}
